...
// The signed-in user's Profile page and its useCurrentUser query.
export async function writeProfileFeature(root: string): Promise<void> {
  await write(root, "src/features/profile/useCurrentUser.ts", [
  ...
  await write(root, "src/features/profile/ProfilePage.tsx", [
