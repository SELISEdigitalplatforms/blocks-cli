...
export async function writeI18n(root: string): Promise<void> {
  ...
  await write(root, "blocks/localization/dashboard.en.json", JSON.stringify({
    "subtitle": "Reference app state and Blocks SDK usage.",
    "title": "Dashboard"
  }, null, 2));
  ...
  await write(root, "blocks/localization/assets.en.json", JSON.stringify({
    ...
    "filters.empty": "No assets match the current filters.",
    "filters.maxValue": "Max value",
    "filters.minValue": "Min value",
    "filters.toggle": "Filters",
    "name": "Name",
    "pagination.rows": "Rows",
    "search": "Search assets",
    "status": "Status",
    "subtitle": "CRUD reference backed by Blocks Data collection Assets.",
    "title": "Assets",
    "value": "Value"
  }, null, 2));
  ...
  await write(root, "src/lib/i18n/LocalizationProvider.tsx", [
    ...
    "      const dictionary = await blocksClient.localization.translations(moduleName, language);",
    ...
    "      }));",
    "    }))",
    "      .then((dictionaries) => setCloudDictionary(Object.assign({}, ...dictionaries)))",
