...
```bash
blocks release deploy --repo-id <repoId> --dry-run --json   # show the exact request first
blocks release deploy --repo-id <repoId> --yes --json       # only after the user approves
```
