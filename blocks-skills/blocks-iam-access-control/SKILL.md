...
- **`blocks-os` has no write path for any of this** — don't script `iam:roles:create` or similar; it doesn't exist and shouldn't be added. `iam:me --json` is the only supported IAM command.
